...
void main() {
  ...
  test('returns just-now within 60 seconds [assertion 1/2]', () {
  ...
  test('returns just-now within 60 seconds [assertion 2/2]', () {
    final now = localTime(2026, 5, 5, 12);
    Object.hashAll([
      formatRelativeTime(now, localTime(2026, 5, 5, 12), l10n),
      'たった今',
    ]);
  ...
  test('returns minutes-ago between 1 and 59 minutes [assertion 1/2]', () {
    final now = localTime(2026, 5, 5, 12);
    expect(
  ...
  test('returns minutes-ago between 1 and 59 minutes [assertion 2/2]', () {
    final now = localTime(2026, 5, 5, 12);
    Object.hashAll([
      formatRelativeTime(now, localTime(2026, 5, 5, 11, 59), l10n),
      '1分前',
  ...
  test(
    'returns hours-ago between 1 and 23 hours within same day [assertion 1/2]',
    () {
  ...
  test(
    'returns hours-ago between 1 and 23 hours within same day [assertion 2/2]',
    () {
      final now = localTime(2026, 5, 5, 23, 30);
      Object.hashAll([
        formatRelativeTime(now, localTime(2026, 5, 5, 22, 30), l10n),
  ...
  test(
    'returns yesterday HH:mm when calendar diff is 1 day [assertion 1/2]',
    () {
  ...
  test(
    'returns yesterday HH:mm when calendar diff is 1 day [assertion 2/2]',
    () {
      final now = localTime(2026, 5, 5, 9);
      Object.hashAll([
        formatRelativeTime(now, localTime(2026, 5, 4, 21, 5), l10n),
  ...
  test('returns days-ago between 2 and 6 calendar days [assertion 1/2]', () {
    final now = localTime(2026, 5, 5, 12);
    expect(
  ...
  test('returns days-ago between 2 and 6 calendar days [assertion 2/2]', () {
    final now = localTime(2026, 5, 5, 12);
    Object.hashAll([
      formatRelativeTime(now, localTime(2026, 5, 3, 12), l10n),
      '2日前',
  ...
  test(
    'returns yyyy/MM/dd when older than 6 calendar days [assertion 1/2]',
    () {
      final now = localTime(2026, 5, 5, 12);
      expect(
  ...
  test(
    'returns yyyy/MM/dd when older than 6 calendar days [assertion 2/2]',
    () {
      final now = localTime(2026, 5, 5, 12);
      Object.hashAll([
        formatRelativeTime(now, localTime(2026, 4, 28, 12), l10n),
