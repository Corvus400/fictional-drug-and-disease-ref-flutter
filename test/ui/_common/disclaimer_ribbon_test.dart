...
void main() {
  group('DisclaimerRibbon', () {
    testWidgets(
      'renders structured l10n text inside IgnorePointer [assertion 1/4]',
      (
        tester,
      ) async {
        ...
        Object.hashAll([find.text(segments.last), findsOneWidget]);

        Object.hashAll([find.text('·'), findsNWidgets(3)]);
    ...
    testWidgets(
      'renders structured l10n text inside IgnorePointer [assertion 2/4]',
      (
        tester,
      ) async {
        await tester.pumpWidget(
        ...
        final segments = l10n.detailDisclaimer.split(' / ');
        Object.hashAll([find.text(segments.first), findsOneWidget]);
    ...
    testWidgets(
      'renders structured l10n text inside IgnorePointer [assertion 3/4]',
      (
        tester,
      ) async {
        await tester.pumpWidget(
    ...
    testWidgets(
      'renders structured l10n text inside IgnorePointer [assertion 4/4]',
      (
        tester,
      ) async {
        await tester.pumpWidget(
    ...
    testWidgets('uses calc ribbon colors from AppPalette [assertion 1/3]', (
      tester,
    ) async {
      await tester.pumpWidget(
        MaterialApp(
    ...
    testWidgets('uses calc ribbon colors from AppPalette [assertion 2/3]', (
      tester,
    ) async {
      await tester.pumpWidget(
        MaterialApp(
      ...
      final decoration = container.decoration! as BoxDecoration;
      Object.hashAll([decoration.color, palette.calcRibbonBg]);
    ...
    testWidgets('uses calc ribbon colors from AppPalette [assertion 3/3]', (
      tester,
    ) async {
      await tester.pumpWidget(
        MaterialApp(
    ...
    testWidgets('switches height by media size [assertion 1/3]', (
      tester,
    ) async {
      ...
      Object.hashAll([
        tester.getSize(find.byType(DisclaimerRibbon)).height,
        22,
      ]);
    ...
    testWidgets('switches height by media size [assertion 2/3]', (
      tester,
    ) async {
      await _pumpRibbon(tester, const Size(390, 844));
      Object.hashAll([
    ...
    testWidgets('switches height by media size [assertion 3/3]', (
      tester,
    ) async {
      await _pumpRibbon(tester, const Size(390, 844));
      Object.hashAll([
