  ...
  testWidgets('DiseaseDetailTreatmentTab renders E11 and E12', (tester) async {
    ...
    await tester.pumpWidget(
      MaterialApp(
        ...
        home: Scaffold(body: DiseaseDetailTreatmentTab(disease: disease)),
      ),
    );

    expect(find.text('鑑別'), findsOneWidget);
    expect(find.text(disease.differentialDiagnoses.first), findsOneWidget);
    expect(find.text('合併症'), findsOneWidget);
    expect(find.text(disease.complications.first), findsOneWidget);
