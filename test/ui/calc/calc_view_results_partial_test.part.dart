...
void _calcViewResultsPartialTests() {
  testWidgets(
    'does not render undefined app bar action buttons [assertion 1/3]',
    (
      tester,
    ) async {
      ...
      Object.hashAll([find.byIcon(Icons.menu), findsNothing]);

      Object.hashAll([find.byIcon(Icons.history), findsNothing]);
    },
  );

  testWidgets(
    'does not render undefined app bar action buttons [assertion 2/3]',
    (
      tester,
    ) async {
      await tester.pumpWidget(_testApp(db));
      ...
      Object.hashAll([find.text('計算ツール'), findsOneWidget]);
  ...
  testWidgets(
    'does not render undefined app bar action buttons [assertion 3/3]',
    (
      tester,
    ) async {
      await tester.pumpWidget(_testApp(db));
  ...
  testWidgets(
    'does not toggle history when there are no rows [assertion 1/9]',
    (
      tester,
    ) async {
      await tester.pumpWidget(_testApp(db));
      ...
      Object.hashAll([
        _historyHeaderIcon(Icons.history_toggle_off),
        findsOneWidget,
      ]);

      Object.hashAll([find.byIcon(Icons.expand_less), findsNothing]);

      Object.hashAll([find.byIcon(Icons.expand_more), findsNothing]);
      ...
      Object.hashAll([_richTextContaining('BMI 22.5'), findsNothing]);
    },
  );

  testWidgets(
    'does not toggle history when there are no rows [assertion 2/9]',
    (
      tester,
    ) async {
      await tester.pumpWidget(_testApp(db));
  ...
  testWidgets(
    'does not toggle history when there are no rows [assertion 3/9]',
    (
      tester,
    ) async {
      await tester.pumpWidget(_testApp(db));
  ...
  testWidgets(
    'does not toggle history when there are no rows [assertion 4/9]',
    (
      tester,
    ) async {
      await tester.pumpWidget(_testApp(db));
  ...
  testWidgets(
    'does not toggle history when there are no rows [assertion 5/9]',
    (
      tester,
    ) async {
      await tester.pumpWidget(_testApp(db));
  ...
  testWidgets(
    'does not toggle history when there are no rows [assertion 6/9]',
    (
      tester,
    ) async {
      await tester.pumpWidget(_testApp(db));
  ...
  testWidgets(
    'does not toggle history when there are no rows [assertion 7/9]',
    (
      tester,
    ) async {
      await tester.pumpWidget(_testApp(db));
  ...
  testWidgets(
    'does not toggle history when there are no rows [assertion 8/9]',
    (
      tester,
    ) async {
      await tester.pumpWidget(_testApp(db));
  ...
  testWidgets(
    'does not toggle history when there are no rows [assertion 9/9]',
    (
      tester,
    ) async {
      await tester.pumpWidget(_testApp(db));
  ...
  testWidgets(
    'history error renders the same empty history surface [assertion 1/3]',
    (
      tester,
    ) async {
  ...
  testWidgets(
    'history error renders the same empty history surface [assertion 2/3]',
    (
      tester,
    ) async {
      final errorState = CalcScreenState.initial().copyWith(
  ...
  testWidgets(
    'history error renders the same empty history surface [assertion 3/3]',
    (
      tester,
    ) async {
      final errorState = CalcScreenState.initial().copyWith(
  ...
  testWidgets('updates BMI result while values are entered [assertion 1/3]', (
    tester,
  ) async {
    await tester.pumpWidget(_testApp(db));
    await tester.pump();
    ...
    Object.hashAll([find.text('すべての項目を入力してください'), findsNothing]);
  });

  testWidgets('updates BMI result while values are entered [assertion 2/3]', (
    tester,
  ) async {
    await tester.pumpWidget(_testApp(db));
    await tester.pump();
    ...
    Object.hashAll([find.text('22.5'), findsWidgets]);

    expect(find.text('普通体重'), findsOneWidget);
    Object.hashAll([find.text('すべての項目を入力してください'), findsNothing]);
  });

  testWidgets('updates BMI result while values are entered [assertion 3/3]', (
    tester,
  ) async {
    await tester.pumpWidget(_testApp(db));
    await tester.pump();
  ...
  testWidgets('switches to eGFR form with sex selector [assertion 1/5]', (
    tester,
  ) async {
    await tester.pumpWidget(_testApp(db));
    await tester.pump();
    ...
    Object.hashAll([find.text('男性'), findsOneWidget]);

    Object.hashAll([find.text('女性'), findsOneWidget]);
  ...
  testWidgets('switches to eGFR form with sex selector [assertion 2/5]', (
    tester,
  ) async {
    await tester.pumpWidget(_testApp(db));
    await tester.pump();
  ...
  testWidgets('switches to eGFR form with sex selector [assertion 3/5]', (
    tester,
  ) async {
    await tester.pumpWidget(_testApp(db));
    await tester.pump();
  ...
  testWidgets('switches to eGFR form with sex selector [assertion 4/5]', (
    tester,
  ) async {
    await tester.pumpWidget(_testApp(db));
    await tester.pump();
  ...
  testWidgets('switches to eGFR form with sex selector [assertion 5/5]', (
    tester,
  ) async {
    await tester.pumpWidget(_testApp(db));
    await tester.pump();
  ...
  testWidgets(
    'keeps every incomplete numeric subset in partial state [assertion 1/4]',
    (
      tester,
    ) async {
      final cases =
  ...
  testWidgets(
    'keeps every incomplete numeric subset in partial state [assertion 2/4]',
    (
      tester,
    ) async {
      final cases =
  ...
  testWidgets(
    'keeps every incomplete numeric subset in partial state [assertion 3/4]',
    (
      tester,
    ) async {
      final cases =
  ...
  testWidgets(
    'keeps every incomplete numeric subset in partial state [assertion 4/4]',
    (
      tester,
    ) async {
      final cases =
  ...
  testWidgets('renders female eGFR result with selected sex [assertion 1/2]', (
    tester,
  ) async {
    await tester.pumpWidget(_testApp(db));
    await tester.pump();
    ...
    Object.hashAll([find.text('G3a 軽度〜中等度低下'), findsOneWidget]);
  });

  testWidgets('renders female eGFR result with selected sex [assertion 2/2]', (
    tester,
  ) async {
    await tester.pumpWidget(_testApp(db));
    await tester.pump();
    ...
    Object.hashAll([find.text('46.6'), findsWidgets]);
