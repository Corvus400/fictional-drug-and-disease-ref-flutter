...
void main() {
  group('Calc history atoms', () {
    testWidgets(
      'CalcHistoryRow renders date, result, summary, and restore [assertion 1/5]',
      (
        tester,
      ) async {
        var restored = false;
        ...
        Object.hashAll([
          ...
          contains('BMI 22.5 (普通体重)'),
        ]);

        Object.hashAll([richText.text.toPlainText(), contains('H170/W65')]);

        Object.hashAll([find.byIcon(Icons.refresh), findsOneWidget]);

        await tester.tap(find.byType(CalcHistoryRow));
        Object.hashAll([restored, isTrue]);
      },
    );

    testWidgets(
      'CalcHistoryRow renders date, result, summary, and restore [assertion 2/5]',
      (
        tester,
      ) async {
        var restored = false;
        ...
        Object.hashAll([richText.text.toPlainText(), contains('2026/05/10')]);
    ...
    testWidgets(
      'CalcHistoryRow renders date, result, summary, and restore [assertion 3/5]',
      (
        tester,
      ) async {
        var restored = false;
    ...
    testWidgets(
      'CalcHistoryRow renders date, result, summary, and restore [assertion 4/5]',
      (
        tester,
      ) async {
        var restored = false;
    ...
    testWidgets(
      'CalcHistoryRow renders date, result, summary, and restore [assertion 5/5]',
      (
        tester,
      ) async {
        var restored = false;
    ...
    testWidgets(
      'CalcHistoryRow delete-revealed state matches dimensions [assertion 1/5]',
      (
        tester,
      ) async {
        await tester.pumpWidget(
    ...
    testWidgets(
      'CalcHistoryRow delete-revealed state matches dimensions [assertion 2/5]',
      (
        tester,
      ) async {
        await tester.pumpWidget(
    ...
    testWidgets(
      'CalcHistoryRow delete-revealed state matches dimensions [assertion 3/5]',
      (
        tester,
      ) async {
        await tester.pumpWidget(
    ...
    testWidgets(
      'CalcHistoryRow delete-revealed state matches dimensions [assertion 4/5]',
      (
        tester,
      ) async {
        await tester.pumpWidget(
    ...
    testWidgets(
      'CalcHistoryRow delete-revealed state matches dimensions [assertion 5/5]',
      (
        tester,
      ) async {
        await tester.pumpWidget(
    ...
    testWidgets(
      'CalcHistoryEmptyState renders icon and message [assertion 1/3]',
      (
        tester,
      ) async {
        await tester.pumpWidget(
    ...
    testWidgets(
      'CalcHistoryEmptyState renders icon and message [assertion 2/3]',
      (
        tester,
      ) async {
        await tester.pumpWidget(
        ...
        Object.hashAll([find.byIcon(Icons.history_toggle_off), findsOneWidget]);
    ...
    testWidgets(
      'CalcHistoryEmptyState renders icon and message [assertion 3/3]',
      (
        tester,
      ) async {
        await tester.pumpWidget(
