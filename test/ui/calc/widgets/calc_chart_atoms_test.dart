...
void main() {
  group('Calc chart atoms', () {
    testWidgets(
      'BmiChart renders seven bands, ticks, and marker [assertion 1/6]',
      (
        tester,
      ) async {
        ...
        Object.hashAll([find.text('10'), findsOneWidget]);

        Object.hashAll([find.text('30'), findsWidgets]);

        Object.hashAll([find.text('50'), findsOneWidget]);

        Object.hashAll([
          tester.getSize(
            find.byKey(const ValueKey<String>('bmi-chart-marker')),
          ),
          const Size(2, 32),
        ]);
    ...
    testWidgets(
      'BmiChart renders seven bands, ticks, and marker [assertion 2/6]',
      (
        tester,
      ) async {
        await tester.pumpWidget(
    ...
    testWidgets(
      'BmiChart renders seven bands, ticks, and marker [assertion 3/6]',
      (
        tester,
      ) async {
        await tester.pumpWidget(
    ...
    testWidgets(
      'BmiChart renders seven bands, ticks, and marker [assertion 4/6]',
      (
        tester,
      ) async {
        await tester.pumpWidget(
    ...
    testWidgets(
      'BmiChart renders seven bands, ticks, and marker [assertion 5/6]',
      (
        tester,
      ) async {
        await tester.pumpWidget(
    ...
    testWidgets(
      'BmiChart renders seven bands, ticks, and marker [assertion 6/6]',
      (
        tester,
      ) async {
        await tester.pumpWidget(
    ...
    testWidgets(
      'BmiChart clamps edge marker labels inside the chart bounds [assertion 1/4]',
      (
        tester,
      ) async {
        await tester.pumpWidget(
        ...
        Object.hashAll([
          rightLabelRect.right,
          lessThanOrEqualTo(chartRect.right),
        ]);

        Object.hashAll([
          tester.getSize(find.text('10.0')).height,
          lessThanOrEqualTo(13),
        ]);

        Object.hashAll([
          tester.getSize(find.text('50.0')).height,
          lessThanOrEqualTo(13),
        ]);
      },
    );
    ...
    testWidgets(
      'BmiChart clamps edge marker labels inside the chart bounds [assertion 2/4]',
      (
        tester,
      ) async {
        await tester.pumpWidget(
    ...
    testWidgets(
      'BmiChart clamps edge marker labels inside the chart bounds [assertion 3/4]',
      (
        tester,
      ) async {
        await tester.pumpWidget(
    ...
    testWidgets(
      'BmiChart clamps edge marker labels inside the chart bounds [assertion 4/4]',
      (
        tester,
      ) async {
        await tester.pumpWidget(
    ...
    testWidgets(
      'EgfrChart renders CKD stage bands and marker [assertion 1/5]',
      (tester) async {
        await tester.pumpWidget(
          _widgetTestApp(
            child: const SizedBox(
        ...
        Object.hashAll([find.text('0'), findsOneWidget]);

        Object.hashAll([find.text('120'), findsOneWidget]);

        Object.hashAll([
          tester.getSize(
            find.byKey(const ValueKey<String>('egfr-chart-marker')),
          ),
          const Size(2, 32),
        ]);

        Object.hashAll([find.text('78.4'), findsOneWidget]);
      },
    );

    testWidgets(
      'EgfrChart renders CKD stage bands and marker [assertion 2/5]',
      (tester) async {
        await tester.pumpWidget(
          _widgetTestApp(
            child: const SizedBox(
    ...
    testWidgets(
      'EgfrChart renders CKD stage bands and marker [assertion 3/5]',
      (tester) async {
        await tester.pumpWidget(
          _widgetTestApp(
            child: const SizedBox(
    ...
    testWidgets(
      'EgfrChart renders CKD stage bands and marker [assertion 4/5]',
      (tester) async {
        await tester.pumpWidget(
          _widgetTestApp(
            child: const SizedBox(
    ...
    testWidgets(
      'EgfrChart renders CKD stage bands and marker [assertion 5/5]',
      (tester) async {
        await tester.pumpWidget(
          _widgetTestApp(
            child: const SizedBox(
    ...
    testWidgets(
      'EgfrChart clamps edge marker labels inside the chart bounds [assertion 1/4]',
      (
        tester,
      ) async {
        await tester.pumpWidget(
        ...
        Object.hashAll([
          tester.getSize(find.text('0.0')).height,
          lessThanOrEqualTo(13),
        ]);

        Object.hashAll([
          tester.getSize(find.text('140.0')).height,
          lessThanOrEqualTo(13),
        ]);
      },
    );
    ...
    testWidgets(
      'EgfrChart clamps edge marker labels inside the chart bounds [assertion 2/4]',
      (
        tester,
      ) async {
        await tester.pumpWidget(
    ...
    testWidgets(
      'EgfrChart clamps edge marker labels inside the chart bounds [assertion 3/4]',
      (
        tester,
      ) async {
        await tester.pumpWidget(
    ...
    testWidgets(
      'EgfrChart clamps edge marker labels inside the chart bounds [assertion 4/4]',
      (
        tester,
      ) async {
        await tester.pumpWidget(
    ...
    testWidgets(
      'CrClChart renders age bands and patient markers [assertion 1/3]',
      (
        tester,
      ) async {
        await tester.pumpWidget(
    ...
    testWidgets(
      'CrClChart renders age bands and patient markers [assertion 2/3]',
      (
        tester,
      ) async {
        await tester.pumpWidget(
    ...
    testWidgets(
      'CrClChart renders age bands and patient markers [assertion 3/3]',
      (
        tester,
      ) async {
        await tester.pumpWidget(
    ...
    testWidgets(
      'CrClChart clamps low and high patient markers to track edges [assertion 1/2]',
      (
        tester,
      ) async {
        await tester.pumpWidget(
        ...
        Object.hashAll([highMarkerRect.right, closeTo(highTrackRect.right, 1)]);
      },
    );

    testWidgets(
      'CrClChart clamps low and high patient markers to track edges [assertion 2/2]',
      (
        tester,
      ) async {
        await tester.pumpWidget(
        ...
        Object.hashAll([lowMarkerRect.left, closeTo(lowTrackRect.left, 1)]);
