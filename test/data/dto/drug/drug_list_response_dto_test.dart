...
void main() {
  test(
    'DrugListResponseDto.fromJson parses Swagger sample [assertion 1/5]',
    () {
      final fixture = File(
      ...
      Object.hashAll([dto.totalCount, 120]);
  ...
  test(
    'DrugListResponseDto.fromJson parses Swagger sample [assertion 2/5]',
    () {
      final fixture = File(
        'test/fixtures/swagger/get_v1_drugs.json',
      ).readAsStringSync();
  ...
  test(
    'DrugListResponseDto.fromJson parses Swagger sample [assertion 3/5]',
    () {
      final fixture = File(
        'test/fixtures/swagger/get_v1_drugs.json',
      ).readAsStringSync();
  ...
  test(
    'DrugListResponseDto.fromJson parses Swagger sample [assertion 4/5]',
    () {
      final fixture = File(
        'test/fixtures/swagger/get_v1_drugs.json',
      ).readAsStringSync();
  ...
  test(
    'DrugListResponseDto.fromJson parses Swagger sample [assertion 5/5]',
    () {
      final fixture = File(
        'test/fixtures/swagger/get_v1_drugs.json',
      ).readAsStringSync();
