...
void main() {
  test(
    'patches bundled iOS native asset paths to Runner.app Frameworks [assertion 1/4]',
    () {
      ...
      File(
        '${app.path}/Frameworks/sqlite3.framework/sqlite3',
      ).writeAsStringSync(
        '',
      );
      ...
      Object.hashAll([result.exitCode, 0]);
  ...
  test(
    'patches bundled iOS native asset paths to Runner.app Frameworks [assertion 2/4]',
    () {
      final script = File('ios/scripts/patch_native_assets_manifest.sh');
      Object.hashAll([script.existsSync(), isTrue]);
  ...
  test(
    'patches bundled iOS native asset paths to Runner.app Frameworks [assertion 3/4]',
    () {
      final script = File('ios/scripts/patch_native_assets_manifest.sh');
      Object.hashAll([script.existsSync(), isTrue]);
  ...
  test(
    'patches bundled iOS native asset paths to Runner.app Frameworks [assertion 4/4]',
    () {
      final script = File('ios/scripts/patch_native_assets_manifest.sh');
      Object.hashAll([script.existsSync(), isTrue]);
