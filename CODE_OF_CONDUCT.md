...
For non-sensitive moderation concerns that are appropriate to discuss publicly,
open a GitHub Issue using the available issue forms.

Do not post private personal information, secrets, access tokens, or reports
that require confidentiality in public issues. For sensitive reports, use the
private contact path linked from this repository's Security policy.
